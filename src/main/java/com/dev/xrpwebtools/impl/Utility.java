...
public class Utility {
    public static class mainUtilities{
        ...
        public String getLocalDateTimeHEX(){
    ...
    public static class htmlBuilder{
        ...
        public String createHTML(byte[] item, String nftName, String nftAuthor, String nftEmail, String nftTwitter, String nftDescription) throws IOException {
            ...
            this.nftEmail = utlt.sanitizeHTMLInput(nftEmail);
            this.nftTwitter = utlt.sanitizeHTMLInput(nftTwitter);
            this.nftDescription = utlt.sanitizeHTMLInput(nftDescription);

            Multihash nftItem = utlt.createIPFS(item);
            String Website = "null";
            ...
            Multihash nftHtml = utlt.createIPFS(htmlBuilder.toString().getBytes());
            utlt.createDomainValue(2, Optional.of("ipfs"), Optional.of(String.valueOf(nftHtml)));
