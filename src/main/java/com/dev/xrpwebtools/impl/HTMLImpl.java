...
public class HTMLImpl {
    ...
    private static void domainBuilder(int mode, Optional<String> protocol, Optional<String> pointer, String... groupResource){
    ...
    public static String createHTML(byte[] item, String nftName, String nftAuthor, String nftEmail, String nftTwitter, String nftDescription) throws IOException {
        String Website = "null";
        ...
        //HTML Builder
        String nftName1 = sanitizeInput(nftName);
        String nftAuthor1 = sanitizeInput(nftAuthor);
        String nftEmail1 = sanitizeInput(nftEmail);
        String nftTwitter1 = sanitizeInput(nftTwitter);
        String nftDescription1 = sanitizeInput(nftDescription);
        ...
        html.append("<html lang=\"en\">\n" +
                ...
                "    </script>\n" +
                "</body></html>");
        Multihash nftHtml = createIPFS(html.toString().getBytes());

        domainBuilder(2, Optional.of("ipfs"), Optional.of(String.valueOf(nftHtml)));
        domainBuilder(2, Optional.of("ipfs"), Optional.of(String.valueOf(nftItem)));
        domainBuilder(2, Optional.of("http"), Optional.of(CreatedAt));
