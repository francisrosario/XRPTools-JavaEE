...
public class BLL {
    ...
    **/
    ...
    public void nftHTML(byte[] itemByte, String nftSeed, String nftName, String nftAuthor, String nftEmail, String nftTwitter, String nftDescription) throws JsonRpcClientErrorException, IOException {
        ...
        for(int x = 0; x < 5; x++) {
            ...
            ImmutablePair<Object, Object> data = createXRPAccount();
            String seed = String.valueOf(data.getRight());
            System.out.println(data.left);

            transactionHASH = domainSet(domainValue, Optional.of(seed));
            for(int z = 0; z < 5; z++){
                ImmutablePair<Object, Object> datax = createXRPAccount();
                String seedx = String.valueOf(datax.getRight());

                transactionHASH = domainSet(domainValue, Optional.of(seedx));
            }
